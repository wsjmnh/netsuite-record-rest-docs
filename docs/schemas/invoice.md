...
Property tables for definitions owned by `invoice`.

Record page: [invoice](../records/invoice.md).

## Index

- [invoice](#invoice) — 235 properties
- [invoice-accountingBookDetailCollection](#invoice-accountingbookdetailcollection) — 6 properties
- [invoice-accountingBookDetailElement](#invoice-accountingbookdetailelement) — 7 properties
- [invoice-appliedRulesCollection](#invoice-appliedrulescollection) — 6 properties
- [invoice-appliedRulesElement](#invoice-appliedruleselement) — 9 properties
- [invoice-billingAddress](#invoice-billingaddress) — 18 properties
- [invoice-expCostCollection](#invoice-expcostcollection) — 6 properties
- [invoice-expCostElement](#invoice-expcostelement) — 36 properties
- [invoice-giftCertRedemptionCollection](#invoice-giftcertredemptioncollection) — 6 properties
- [invoice-giftCertRedemptionElement](#invoice-giftcertredemptionelement) — 4 properties
- [invoice-installmentCollection](#invoice-installmentcollection) — 6 properties
- [invoice-installmentElement](#invoice-installmentelement) — 13 properties
- [invoice-item-inventoryDetail](#invoice-item-inventorydetail) — 11 properties
- [invoice-item-inventoryDetail-inventoryAssignmentCollection](#invoice-item-inventorydetail-inventoryassignmentcollection) — 6 properties
- [invoice-item-inventoryDetail-inventoryAssignmentElement](#invoice-item-inventorydetail-inventoryassignmentelement) — 17 properties
- [invoice-itemCollection](#invoice-itemcollection) — 6 properties
- [invoice-itemCost-inventoryDetail](#invoice-itemcost-inventorydetail) — 11 properties
- [invoice-itemCost-inventoryDetail-inventoryAssignmentCollection](#invoice-itemcost-inventorydetail-inventoryassignmentcollection) — 6 properties
- [invoice-itemCost-inventoryDetail-inventoryAssignmentElement](#invoice-itemcost-inventorydetail-inventoryassignmentelement) — 17 properties
- [invoice-itemCostCollection](#invoice-itemcostcollection) — 6 properties
- [invoice-itemCostElement](#invoice-itemcostelement) — 42 properties
- [invoice-itemElement](#invoice-itemelement) — 125 properties
- [invoice-partnersCollection](#invoice-partnerscollection) — 6 properties
- [invoice-partnersElement](#invoice-partnerselement) — 6 properties
- [invoice-promotionsCollection](#invoice-promotionscollection) — 6 properties
- [invoice-promotionsElement](#invoice-promotionselement) — 4 properties
- [invoice-salesTeamCollection](#invoice-salesteamcollection) — 6 properties
- [invoice-salesTeamElement](#invoice-salesteamelement) — 8 properties
- [invoice-shipGroupCollection](#invoice-shipgroupcollection) — 6 properties
- [invoice-shipGroupElement](#invoice-shipgroupelement) — 29 properties
- [invoice-shippingAddress](#invoice-shippingaddress) — 18 properties
- [invoice-taxDetailsCollection](#invoice-taxdetailscollection) — 6 properties
- [invoice-taxDetailsElement](#invoice-taxdetailselement) — 14 properties
- [invoice-timeCollection](#invoice-timecollection) — 6 properties
- [invoice-timeElement](#invoice-timeelement) — 39 properties
- [invoiceCollection](#invoicecollection) — 6 properties
- [invoiceSelectOptions](#invoiceselectoptions) — 55 properties

## invoice

Browser definition `invoice`.

| Property | Label | Type | Format | Flags | Ref | Enum |
| --- | --- | --- | --- | --- | --- | --- |
| `abbrevType` | Abbrev. Type | string |  |  |  |  |
| `account` |  | account |  |  | [`account`](account.md#account) |  |
| `accountingBookDetail` |  | invoice-accountingBookDetailCollection |  |  | [`invoice-accountingBookDetailCollection`](#invoice-accountingbookdetailcollection) |  |
...
| `appliedRules` |  | invoice-appliedRulesCollection |  |  | [`invoice-appliedRulesCollection`](#invoice-appliedrulescollection) |  |
...
| `billingAddress` |  | invoice-billingAddress |  |  | [`invoice-billingAddress`](#invoice-billingaddress) |  |
...
| `expCost` |  | invoice-expCostCollection |  |  | [`invoice-expCostCollection`](#invoice-expcostcollection) |  |
...
| `giftCertRedemption` |  | invoice-giftCertRedemptionCollection |  |  | [`invoice-giftCertRedemptionCollection`](#invoice-giftcertredemptioncollection) |  |
...
| `installment` |  | invoice-installmentCollection |  |  | [`invoice-installmentCollection`](#invoice-installmentcollection) |  |
...
| `item` |  | invoice-itemCollection |  |  | [`invoice-itemCollection`](#invoice-itemcollection) |  |
| `itemCost` |  | invoice-itemCostCollection |  |  | [`invoice-itemCostCollection`](#invoice-itemcostcollection) |  |
...
| `partners` |  | invoice-partnersCollection |  |  | [`invoice-partnersCollection`](#invoice-partnerscollection) |  |
| `paymentlink` | Payment Link | string |  |  |  |  |
| `postingPeriod` |  | accountingPeriod |  |  | [`accountingPeriod`](accountingPeriod.md#accountingperiod) |  |
| `predictedOverdueDays` | Predicted Overdue Days | integer | int64 |  |  |  |
| `predictedPaymentDate` | Predicted Payment Date | string | date |  |  |  |
| `predictedPaymentDateAvailability` |  | object |  |  |  |  |
| `predictedPaymentDateAvailability.id` | Internal identifier | string |  |  |  | `AVAILABLE`, `UNAVAILABLE_NOT_ENOUGH_DATA` |
| `predictedPaymentDateAvailability.refName` | Reference Name | string |  |  |  |  |
| `predictedPaymentDateLastUpdated` | Predicted Payment Date Last Updated | string | date |  |  |  |
...
| `promotions` |  | invoice-promotionsCollection |  |  | [`invoice-promotionsCollection`](#invoice-promotionscollection) |  |
...
| `salesTeam` |  | invoice-salesTeamCollection |  |  | [`invoice-salesTeamCollection`](#invoice-salesteamcollection) |  |
...
| `shipGroup` |  | invoice-shipGroupCollection |  |  | [`invoice-shipGroupCollection`](#invoice-shipgroupcollection) |  |
...
| `shippingAddress` |  | invoice-shippingAddress |  |  | [`invoice-shippingAddress`](#invoice-shippingaddress) |  |
...
| `status` |  | object |  |  |  |  |
| `status.id` | Internal identifier | string |  |  |  | `A`, `B`, `D`, `E`, `V` |
...
| `taxDetails` |  | invoice-taxDetailsCollection |  |  | [`invoice-taxDetailsCollection`](#invoice-taxdetailscollection) |  |
...
| `time` |  | invoice-timeCollection |  |  | [`invoice-timeCollection`](#invoice-timecollection) |  |
...
| `userEstimateSource` |  | object |  |  |  |  |
| `userEstimateSource.id` | Internal identifier | string |  |  |  | `COMPANY_ESTIMATE`, `CUSTOMER_PROMISED_DATE` |
| `userEstimateSource.refName` | Reference Name | string |  |  |  |  |
| `userEstimatedPaymentDate` | User-Estimated Payment Date | string | date |  |  |  |
...
Browser definition `invoice-accountingBookDetailCollection`.

| Property | Label | Type | Format | Flags | Ref | Enum |
| --- | --- | --- | --- | --- | --- | --- |
| `count` | Count | integer | int64 | read-only |  |  |
| `hasMore` | Has More Results | boolean |  | read-only |  |  |
| `items` |  | invoice-accountingBookDetailElement[] |  |  | [`invoice-accountingBookDetailElement`](#invoice-accountingbookdetailelement) |  |
| `links` | Links | nsLink[] |  | read-only | [`nsLink`](ns.md#nslink) |  |
...
Browser definition `invoice-accountingBookDetailElement`.
...
Browser definition `invoice-appliedRulesCollection`.

| Property | Label | Type | Format | Flags | Ref | Enum |
| --- | --- | --- | --- | --- | --- | --- |
| `count` | Count | integer | int64 | read-only |  |  |
| `hasMore` | Has More Results | boolean |  | read-only |  |  |
| `items` |  | invoice-appliedRulesElement[] |  |  | [`invoice-appliedRulesElement`](#invoice-appliedruleselement) |  |
| `links` | Links | nsLink[] |  | read-only | [`nsLink`](ns.md#nslink) |  |
| `offset` | Query Offset | integer | int64 | read-only |  |  |
| `totalResults` | Total Results | integer | int64 | read-only |  |  |
...
Browser definition `invoice-appliedRulesElement`.
...
Browser definition `invoice-billingAddress`.
...
Browser definition `invoice-expCostCollection`.

| Property | Label | Type | Format | Flags | Ref | Enum |
| --- | --- | --- | --- | --- | --- | --- |
| `count` | Count | integer | int64 | read-only |  |  |
| `hasMore` | Has More Results | boolean |  | read-only |  |  |
| `items` |  | invoice-expCostElement[] |  |  | [`invoice-expCostElement`](#invoice-expcostelement) |  |
| `links` | Links | nsLink[] |  | read-only | [`nsLink`](ns.md#nslink) |  |
| `offset` | Query Offset | integer | int64 | read-only |  |  |
| `totalResults` | Total Results | integer | int64 | read-only |  |  |
...
Browser definition `invoice-expCostElement`.
...
Browser definition `invoice-giftCertRedemptionCollection`.

| Property | Label | Type | Format | Flags | Ref | Enum |
| --- | --- | --- | --- | --- | --- | --- |
| `count` | Count | integer | int64 | read-only |  |  |
| `hasMore` | Has More Results | boolean |  | read-only |  |  |
| `items` |  | invoice-giftCertRedemptionElement[] |  |  | [`invoice-giftCertRedemptionElement`](#invoice-giftcertredemptionelement) |  |
| `links` | Links | nsLink[] |  | read-only | [`nsLink`](ns.md#nslink) |  |
| `offset` | Query Offset | integer | int64 | read-only |  |  |
| `totalResults` | Total Results | integer | int64 | read-only |  |  |
...
Browser definition `invoice-giftCertRedemptionElement`.
...
Browser definition `invoice-installmentCollection`.

| Property | Label | Type | Format | Flags | Ref | Enum |
| --- | --- | --- | --- | --- | --- | --- |
| `count` | Count | integer | int64 | read-only |  |  |
| `hasMore` | Has More Results | boolean |  | read-only |  |  |
| `items` |  | invoice-installmentElement[] |  |  | [`invoice-installmentElement`](#invoice-installmentelement) |  |
| `links` | Links | nsLink[] |  | read-only | [`nsLink`](ns.md#nslink) |  |
| `offset` | Query Offset | integer | int64 | read-only |  |  |
| `totalResults` | Total Results | integer | int64 | read-only |  |  |
...
Browser definition `invoice-installmentElement`.
...
Browser definition `invoice-item-inventoryDetail`.

| Property | Label | Type | Format | Flags | Ref | Enum |
| --- | --- | --- | --- | --- | --- | --- |
| `customForm` |  | nsResource |  |  | [`nsResource`](ns.md#nsresource) |  |
| `externalId` | External ID | string |  |  |  |  |
| `inventoryAssignment` |  | invoice-item-inventoryDetail-inventoryAssignmentCollection |  |  | [`invoice-item-inventoryDetail-inventoryAssignmentCollection`](#invoice-item-inventorydetail-inventoryassignmentcollection) |  |
...
Browser definition `invoice-item-inventoryDetail-inventoryAssignmentCollection`.

| Property | Label | Type | Format | Flags | Ref | Enum |
| --- | --- | --- | --- | --- | --- | --- |
| `count` | Count | integer | int64 | read-only |  |  |
| `hasMore` | Has More Results | boolean |  | read-only |  |  |
| `items` |  | invoice-item-inventoryDetail-inventoryAssignmentElement[] |  |  | [`invoice-item-inventoryDetail-inventoryAssignmentElement`](#invoice-item-inventorydetail-inventoryassignmentelement) |  |
| `links` | Links | nsLink[] |  | read-only | [`nsLink`](ns.md#nslink) |  |
| `offset` | Query Offset | integer | int64 | read-only |  |  |
| `totalResults` | Total Results | integer | int64 | read-only |  |  |
...
Browser definition `invoice-item-inventoryDetail-inventoryAssignmentElement`.
...
Browser definition `invoice-itemCollection`.

| Property | Label | Type | Format | Flags | Ref | Enum |
| --- | --- | --- | --- | --- | --- | --- |
| `count` | Count | integer | int64 | read-only |  |  |
| `hasMore` | Has More Results | boolean |  | read-only |  |  |
| `items` |  | invoice-itemElement[] |  |  | [`invoice-itemElement`](#invoice-itemelement) |  |
| `links` | Links | nsLink[] |  | read-only | [`nsLink`](ns.md#nslink) |  |
| `offset` | Query Offset | integer | int64 | read-only |  |  |
| `totalResults` | Total Results | integer | int64 | read-only |  |  |
...
Browser definition `invoice-itemCost-inventoryDetail`.

| Property | Label | Type | Format | Flags | Ref | Enum |
| --- | --- | --- | --- | --- | --- | --- |
| `customForm` |  | nsResource |  |  | [`nsResource`](ns.md#nsresource) |  |
| `externalId` | External ID | string |  |  |  |  |
| `inventoryAssignment` |  | invoice-itemCost-inventoryDetail-inventoryAssignmentCollection |  |  | [`invoice-itemCost-inventoryDetail-inventoryAssignmentCollection`](#invoice-itemcost-inventorydetail-inventoryassignmentcollection) |  |
| `item` |  | kitItem |  |  | [`kitItem`](kitItem.md#kititem) |  |
| `itemDescription` | Description | string |  |  |  |  |
| `links` | Links | nsLink[] |  | read-only | [`nsLink`](ns.md#nslink) |  |
| `location` |  | location |  |  | [`location`](location.md#location) |  |
...
Browser definition `invoice-itemCost-inventoryDetail-inventoryAssignmentCollection`.

| Property | Label | Type | Format | Flags | Ref | Enum |
| --- | --- | --- | --- | --- | --- | --- |
| `count` | Count | integer | int64 | read-only |  |  |
| `hasMore` | Has More Results | boolean |  | read-only |  |  |
| `items` |  | invoice-itemCost-inventoryDetail-inventoryAssignmentElement[] |  |  | [`invoice-itemCost-inventoryDetail-inventoryAssignmentElement`](#invoice-itemcost-inventorydetail-inventoryassignmentelement) |  |
| `links` | Links | nsLink[] |  | read-only | [`nsLink`](ns.md#nslink) |  |
| `offset` | Query Offset | integer | int64 | read-only |  |  |
| `totalResults` | Total Results | integer | int64 | read-only |  |  |
...
Browser definition `invoice-itemCost-inventoryDetail-inventoryAssignmentElement`.
...
Browser definition `invoice-itemCostCollection`.

| Property | Label | Type | Format | Flags | Ref | Enum |
| --- | --- | --- | --- | --- | --- | --- |
| `count` | Count | integer | int64 | read-only |  |  |
| `hasMore` | Has More Results | boolean |  | read-only |  |  |
| `items` |  | invoice-itemCostElement[] |  |  | [`invoice-itemCostElement`](#invoice-itemcostelement) |  |
| `links` | Links | nsLink[] |  | read-only | [`nsLink`](ns.md#nslink) |  |
| `offset` | Query Offset | integer | int64 | read-only |  |  |
| `totalResults` | Total Results | integer | int64 | read-only |  |  |
...
Browser definition `invoice-itemCostElement`.
...
| `doc` |  | nsResource |  |  | [`nsResource`](ns.md#nsresource) |  |
| `grossAmt` | Gross Amount | number | double |  |  |  |
| `inventoryDetail` |  | invoice-itemCost-inventoryDetail |  |  | [`invoice-itemCost-inventoryDetail`](#invoice-itemcost-inventorydetail) |  |
| `item` |  | kitItem |  |  | [`kitItem`](kitItem.md#kititem) |  |
...
Browser definition `invoice-itemElement`.
...
| `inventoryDetail` |  | invoice-item-inventoryDetail |  |  | [`invoice-item-inventoryDetail`](#invoice-item-inventorydetail) |  |
...
Browser definition `invoice-partnersCollection`.

| Property | Label | Type | Format | Flags | Ref | Enum |
| --- | --- | --- | --- | --- | --- | --- |
| `count` | Count | integer | int64 | read-only |  |  |
| `hasMore` | Has More Results | boolean |  | read-only |  |  |
| `items` |  | invoice-partnersElement[] |  |  | [`invoice-partnersElement`](#invoice-partnerselement) |  |
| `links` | Links | nsLink[] |  | read-only | [`nsLink`](ns.md#nslink) |  |
| `offset` | Query Offset | integer | int64 | read-only |  |  |
| `totalResults` | Total Results | integer | int64 | read-only |  |  |
...
Browser definition `invoice-partnersElement`.
...
## invoice-promotionsCollection

Browser definition `invoice-promotionsCollection`.

| Property | Label | Type | Format | Flags | Ref | Enum |
| --- | --- | --- | --- | --- | --- | --- |
| `count` | Count | integer | int64 | read-only |  |  |
| `hasMore` | Has More Results | boolean |  | read-only |  |  |
| `items` |  | invoice-promotionsElement[] |  |  | [`invoice-promotionsElement`](#invoice-promotionselement) |  |
| `links` | Links | nsLink[] |  | read-only | [`nsLink`](ns.md#nslink) |  |
| `offset` | Query Offset | integer | int64 | read-only |  |  |
| `totalResults` | Total Results | integer | int64 | read-only |  |  |

## invoice-promotionsElement

Browser definition `invoice-promotionsElement`.
...
Browser definition `invoice-salesTeamCollection`.

| Property | Label | Type | Format | Flags | Ref | Enum |
| --- | --- | --- | --- | --- | --- | --- |
| `count` | Count | integer | int64 | read-only |  |  |
| `hasMore` | Has More Results | boolean |  | read-only |  |  |
| `items` |  | invoice-salesTeamElement[] |  |  | [`invoice-salesTeamElement`](#invoice-salesteamelement) |  |
| `links` | Links | nsLink[] |  | read-only | [`nsLink`](ns.md#nslink) |  |
| `offset` | Query Offset | integer | int64 | read-only |  |  |
| `totalResults` | Total Results | integer | int64 | read-only |  |  |
...
Browser definition `invoice-salesTeamElement`.
...
Browser definition `invoice-shipGroupCollection`.

| Property | Label | Type | Format | Flags | Ref | Enum |
| --- | --- | --- | --- | --- | --- | --- |
| `count` | Count | integer | int64 | read-only |  |  |
| `hasMore` | Has More Results | boolean |  | read-only |  |  |
| `items` |  | invoice-shipGroupElement[] |  |  | [`invoice-shipGroupElement`](#invoice-shipgroupelement) |  |
| `links` | Links | nsLink[] |  | read-only | [`nsLink`](ns.md#nslink) |  |
| `offset` | Query Offset | integer | int64 | read-only |  |  |
| `totalResults` | Total Results | integer | int64 | read-only |  |  |
...
Browser definition `invoice-shipGroupElement`.
...
Browser definition `invoice-shippingAddress`.
...
Browser definition `invoice-taxDetailsCollection`.

| Property | Label | Type | Format | Flags | Ref | Enum |
| --- | --- | --- | --- | --- | --- | --- |
| `count` | Count | integer | int64 | read-only |  |  |
| `hasMore` | Has More Results | boolean |  | read-only |  |  |
| `items` |  | invoice-taxDetailsElement[] |  |  | [`invoice-taxDetailsElement`](#invoice-taxdetailselement) |  |
| `links` | Links | nsLink[] |  | read-only | [`nsLink`](ns.md#nslink) |  |
| `offset` | Query Offset | integer | int64 | read-only |  |  |
| `totalResults` | Total Results | integer | int64 | read-only |  |  |
...
Browser definition `invoice-taxDetailsElement`.
...
Browser definition `invoice-timeCollection`.

| Property | Label | Type | Format | Flags | Ref | Enum |
| --- | --- | --- | --- | --- | --- | --- |
| `count` | Count | integer | int64 | read-only |  |  |
| `hasMore` | Has More Results | boolean |  | read-only |  |  |
| `items` |  | invoice-timeElement[] |  |  | [`invoice-timeElement`](#invoice-timeelement) |  |
| `links` | Links | nsLink[] |  | read-only | [`nsLink`](ns.md#nslink) |  |
| `offset` | Query Offset | integer | int64 | read-only |  |  |
| `totalResults` | Total Results | integer | int64 | read-only |  |  |
...
Browser definition `invoice-timeElement`.
...
Browser definition `invoiceCollection`.

| Property | Label | Type | Format | Flags | Ref | Enum |
| --- | --- | --- | --- | --- | --- | --- |
| `count` | Count | integer | int64 | read-only |  |  |
| `hasMore` | Has More Results | boolean |  | read-only |  |  |
| `items` | Items | invoice[] |  |  | [`invoice`](#invoice) |  |
| `links` | Links | nsLink[] |  | read-only | [`nsLink`](ns.md#nslink) |  |
| `offset` | Query Offset | integer | int64 | read-only |  |  |
| `totalResults` | Total Results | integer | int64 | read-only |  |  |
...
Browser definition `invoiceSelectOptions`.
...
| `predictedPaymentDateAvailability` |  | nsResourceSelectOptions |  |  | [`nsResourceSelectOptions`](ns.md#nsresourceselectoptions) |  |
...
| `userEstimateSource` |  | nsResourceSelectOptions |  |  | [`nsResourceSelectOptions`](ns.md#nsresourceselectoptions) |  |
