# Schemas: subtotalItem

Property tables for definitions owned by `subtotalItem`.

Record page: [subtotalItem](../records/subtotalItem.md).

## Index

- [subtotalItem](#subtotalitem) — 19 properties
- [subtotalItem-translationsCollection](#subtotalitem-translationscollection) — 6 properties
- [subtotalItem-translationsElement](#subtotalitem-translationselement) — 16 properties
- [subtotalItemCollection](#subtotalitemcollection) — 6 properties
- [subtotalItemSelectOptions](#subtotalitemselectoptions) — 4 properties

## subtotalItem

Browser definition `subtotalItem`.
...
| `translations` |  | subtotalItem-translationsCollection |  |  | [`subtotalItem-translationsCollection`](#subtotalitem-translationscollection) |  |

## subtotalItem-translationsCollection

Browser definition `subtotalItem-translationsCollection`.

| Property | Label | Type | Format | Flags | Ref | Enum |
| --- | --- | --- | --- | --- | --- | --- |
| `count` | Count | integer | int64 | read-only |  |  |
| `hasMore` | Has More Results | boolean |  | read-only |  |  |
| `items` |  | subtotalItem-translationsElement[] |  |  | [`subtotalItem-translationsElement`](#subtotalitem-translationselement) |  |
| `links` | Links | nsLink[] |  | read-only | [`nsLink`](ns.md#nslink) |  |
...
Browser definition `subtotalItem-translationsElement`.
...
Browser definition `subtotalItemCollection`.

| Property | Label | Type | Format | Flags | Ref | Enum |
| --- | --- | --- | --- | --- | --- | --- |
| `count` | Count | integer | int64 | read-only |  |  |
| `hasMore` | Has More Results | boolean |  | read-only |  |  |
| `items` | Items | subtotalItem[] |  |  | [`subtotalItem`](#subtotalitem) |  |
| `links` | Links | nsLink[] |  | read-only | [`nsLink`](ns.md#nslink) |  |
| `offset` | Query Offset | integer | int64 | read-only |  |  |
| `totalResults` | Total Results | integer | int64 | read-only |  |  |

## subtotalItemSelectOptions

Browser definition `subtotalItemSelectOptions`.
