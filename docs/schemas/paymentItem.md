...
Property tables for definitions owned by `paymentItem`.

Record page: [paymentItem](../records/paymentItem.md).

## Index

- [paymentItem](#paymentitem) — 25 properties
- [paymentItem-translationsCollection](#paymentitem-translationscollection) — 6 properties
- [paymentItem-translationsElement](#paymentitem-translationselement) — 16 properties
- [paymentItemCollection](#paymentitemcollection) — 6 properties
- [paymentItemSelectOptions](#paymentitemselectoptions) — 9 properties

## paymentItem

Browser definition `paymentItem`.
...
| `translations` |  | paymentItem-translationsCollection |  |  | [`paymentItem-translationsCollection`](#paymentitem-translationscollection) |  |
| `undepFunds` | Group with Undeposited Funds | boolean |  |  |  |  |

## paymentItem-translationsCollection

Browser definition `paymentItem-translationsCollection`.

| Property | Label | Type | Format | Flags | Ref | Enum |
| --- | --- | --- | --- | --- | --- | --- |
| `count` | Count | integer | int64 | read-only |  |  |
| `hasMore` | Has More Results | boolean |  | read-only |  |  |
| `items` |  | paymentItem-translationsElement[] |  |  | [`paymentItem-translationsElement`](#paymentitem-translationselement) |  |
| `links` | Links | nsLink[] |  | read-only | [`nsLink`](ns.md#nslink) |  |
...
Browser definition `paymentItem-translationsElement`.
...
Browser definition `paymentItemCollection`.

| Property | Label | Type | Format | Flags | Ref | Enum |
| --- | --- | --- | --- | --- | --- | --- |
| `count` | Count | integer | int64 | read-only |  |  |
| `hasMore` | Has More Results | boolean |  | read-only |  |  |
| `items` | Items | paymentItem[] |  |  | [`paymentItem`](#paymentitem) |  |
| `links` | Links | nsLink[] |  | read-only | [`nsLink`](ns.md#nslink) |  |
| `offset` | Query Offset | integer | int64 | read-only |  |  |
| `totalResults` | Total Results | integer | int64 | read-only |  |  |

## paymentItemSelectOptions

Browser definition `paymentItemSelectOptions`.
