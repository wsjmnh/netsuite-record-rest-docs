...
Property tables for definitions owned by `currency`.

Record page: [currency](../records/currency.md).

## Index

- [currency](#currency) — 25 properties
- [currencyCollection](#currencycollection) — 6 properties
- [currencySelectOptions](#currencyselectoptions) — 3 properties

## currency

Browser definition `currency`.
...
| `fxRateUpdateTimezone.id` | Internal identifier | string |  |  |  | `1`, `2`, `3`, `4` |
| `fxRateUpdateTimezone.refName` | Reference Name | string |  |  |  |  |
...
Browser definition `currencyCollection`.

| Property | Label | Type | Format | Flags | Ref | Enum |
| --- | --- | --- | --- | --- | --- | --- |
| `count` | Count | integer | int64 | read-only |  |  |
| `hasMore` | Has More Results | boolean |  | read-only |  |  |
| `items` | Items | currency[] |  |  | [`currency`](#currency) |  |
| `links` | Links | nsLink[] |  | read-only | [`nsLink`](ns.md#nslink) |  |
...
Browser definition `currencySelectOptions`.

| Property | Label | Type | Format | Flags | Ref | Enum |
| --- | --- | --- | --- | --- | --- | --- |
| `fxRateUpdateTimezone` |  | nsResourceSelectOptions |  |  | [`nsResourceSelectOptions`](ns.md#nsresourceselectoptions) |  |
| `locale` |  | nsResourceSelectOptions |  |  | [`nsResourceSelectOptions`](ns.md#nsresourceselectoptions) |  |
