# Schemas: consolidatedExchangeRate

Property tables for definitions owned by `consolidatedExchangeRate`.

Record page: [consolidatedExchangeRate](../records/consolidatedExchangeRate.md).

## Index

- [consolidatedExchangeRate](#consolidatedexchangerate) — 18 properties
- [consolidatedExchangeRateCollection](#consolidatedexchangeratecollection) — 6 properties
- [consolidatedExchangeRateSelectOptions](#consolidatedexchangerateselectoptions) — 6 properties

## consolidatedExchangeRate

Browser definition `consolidatedExchangeRate`.
...
Browser definition `consolidatedExchangeRateCollection`.

| Property | Label | Type | Format | Flags | Ref | Enum |
| --- | --- | --- | --- | --- | --- | --- |
| `count` | Count | integer | int64 | read-only |  |  |
| `hasMore` | Has More Results | boolean |  | read-only |  |  |
| `items` | Items | consolidatedExchangeRate[] |  |  | [`consolidatedExchangeRate`](#consolidatedexchangerate) |  |
| `links` | Links | nsLink[] |  | read-only | [`nsLink`](ns.md#nslink) |  |
| `offset` | Query Offset | integer | int64 | read-only |  |  |
| `totalResults` | Total Results | integer | int64 | read-only |  |  |

## consolidatedExchangeRateSelectOptions

Browser definition `consolidatedExchangeRateSelectOptions`.
