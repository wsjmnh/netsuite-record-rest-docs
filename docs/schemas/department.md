...
Property tables for definitions owned by `department`.

Record page: [department](../records/department.md).

## Index

- [department](#department) — 13 properties
- [department-classTranslationCollection](#department-classtranslationcollection) — 6 properties
- [department-classTranslationElement](#department-classtranslationelement) — 7 properties
- [departmentCollection](#departmentcollection) — 6 properties
- [departmentSelectOptions](#departmentselectoptions) — 2 properties

## department

Browser definition `department`.

| Property | Label | Type | Format | Flags | Ref | Enum |
| --- | --- | --- | --- | --- | --- | --- |
| `classTranslation` |  | department-classTranslationCollection |  |  | [`department-classTranslationCollection`](#department-classtranslationcollection) |  |
...
Browser definition `department-classTranslationCollection`.

| Property | Label | Type | Format | Flags | Ref | Enum |
| --- | --- | --- | --- | --- | --- | --- |
| `count` | Count | integer | int64 | read-only |  |  |
| `hasMore` | Has More Results | boolean |  | read-only |  |  |
| `items` |  | department-classTranslationElement[] |  |  | [`department-classTranslationElement`](#department-classtranslationelement) |  |
| `links` | Links | nsLink[] |  | read-only | [`nsLink`](ns.md#nslink) |  |
...
Browser definition `department-classTranslationElement`.
...
Browser definition `departmentCollection`.

| Property | Label | Type | Format | Flags | Ref | Enum |
| --- | --- | --- | --- | --- | --- | --- |
| `count` | Count | integer | int64 | read-only |  |  |
| `hasMore` | Has More Results | boolean |  | read-only |  |  |
| `items` | Items | department[] |  |  | [`department`](#department) |  |
| `links` | Links | nsLink[] |  | read-only | [`nsLink`](ns.md#nslink) |  |
| `offset` | Query Offset | integer | int64 | read-only |  |  |
| `totalResults` | Total Results | integer | int64 | read-only |  |  |
...
Browser definition `departmentSelectOptions`.
