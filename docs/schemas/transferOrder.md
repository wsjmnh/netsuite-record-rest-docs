# Schemas: transferOrder

Property tables for definitions owned by `transferOrder`.

Record page: [transferOrder](../records/transferOrder.md).

## Index

- [transferOrder](#transferorder) — 81 properties
- [transferOrder-accountingBookDetailCollection](#transferorder-accountingbookdetailcollection) — 6 properties
- [transferOrder-accountingBookDetailElement](#transferorder-accountingbookdetailelement) — 7 properties
- [transferOrder-item-inventoryDetail](#transferorder-item-inventorydetail) — 11 properties
- [transferOrder-item-inventoryDetail-inventoryAssignmentCollection](#transferorder-item-inventorydetail-inventoryassignmentcollection) — 6 properties
- [transferOrder-item-inventoryDetail-inventoryAssignmentElement](#transferorder-item-inventorydetail-inventoryassignmentelement) — 17 properties
- [transferOrder-itemCollection](#transferorder-itemcollection) — 6 properties
- [transferOrder-itemElement](#transferorder-itemelement) — 63 properties
- [transferOrder-shippingAddress](#transferorder-shippingaddress) — 18 properties
- [transferOrderCollection](#transferordercollection) — 6 properties
- [transferOrderSelectOptions](#transferorderselectoptions) — 23 properties

## transferOrder

Browser definition `transferOrder`.

| Property | Label | Type | Format | Flags | Ref | Enum |
| --- | --- | --- | --- | --- | --- | --- |
| `accountingBookDetail` |  | transferOrder-accountingBookDetailCollection |  |  | [`transferOrder-accountingBookDetailCollection`](#transferorder-accountingbookdetailcollection) |  |
...
| `item` |  | transferOrder-itemCollection |  |  | [`transferOrder-itemCollection`](#transferorder-itemcollection) |  |
...
| `shippingAddress` |  | transferOrder-shippingAddress |  |  | [`transferOrder-shippingAddress`](#transferorder-shippingaddress) |  |
...
Browser definition `transferOrder-accountingBookDetailCollection`.

| Property | Label | Type | Format | Flags | Ref | Enum |
| --- | --- | --- | --- | --- | --- | --- |
| `count` | Count | integer | int64 | read-only |  |  |
| `hasMore` | Has More Results | boolean |  | read-only |  |  |
| `items` |  | transferOrder-accountingBookDetailElement[] |  |  | [`transferOrder-accountingBookDetailElement`](#transferorder-accountingbookdetailelement) |  |
| `links` | Links | nsLink[] |  | read-only | [`nsLink`](ns.md#nslink) |  |
...
Browser definition `transferOrder-accountingBookDetailElement`.
...
Browser definition `transferOrder-item-inventoryDetail`.

| Property | Label | Type | Format | Flags | Ref | Enum |
| --- | --- | --- | --- | --- | --- | --- |
| `customForm` |  | nsResource |  |  | [`nsResource`](ns.md#nsresource) |  |
| `externalId` | External ID | string |  |  |  |  |
| `inventoryAssignment` |  | transferOrder-item-inventoryDetail-inventoryAssignmentCollection |  |  | [`transferOrder-item-inventoryDetail-inventoryAssignmentCollection`](#transferorder-item-inventorydetail-inventoryassignmentcollection) |  |
...
Browser definition `transferOrder-item-inventoryDetail-inventoryAssignmentCollection`.

| Property | Label | Type | Format | Flags | Ref | Enum |
| --- | --- | --- | --- | --- | --- | --- |
| `count` | Count | integer | int64 | read-only |  |  |
| `hasMore` | Has More Results | boolean |  | read-only |  |  |
| `items` |  | transferOrder-item-inventoryDetail-inventoryAssignmentElement[] |  |  | [`transferOrder-item-inventoryDetail-inventoryAssignmentElement`](#transferorder-item-inventorydetail-inventoryassignmentelement) |  |
| `links` | Links | nsLink[] |  | read-only | [`nsLink`](ns.md#nslink) |  |
| `offset` | Query Offset | integer | int64 | read-only |  |  |
| `totalResults` | Total Results | integer | int64 | read-only |  |  |
...
Browser definition `transferOrder-item-inventoryDetail-inventoryAssignmentElement`.
...
Browser definition `transferOrder-itemCollection`.

| Property | Label | Type | Format | Flags | Ref | Enum |
| --- | --- | --- | --- | --- | --- | --- |
| `count` | Count | integer | int64 | read-only |  |  |
| `hasMore` | Has More Results | boolean |  | read-only |  |  |
| `items` |  | transferOrder-itemElement[] |  |  | [`transferOrder-itemElement`](#transferorder-itemelement) |  |
| `links` | Links | nsLink[] |  | read-only | [`nsLink`](ns.md#nslink) |  |
| `offset` | Query Offset | integer | int64 | read-only |  |  |
| `totalResults` | Total Results | integer | int64 | read-only |  |  |
...
Browser definition `transferOrder-itemElement`.
...
| `inventoryDetail` |  | transferOrder-item-inventoryDetail |  |  | [`transferOrder-item-inventoryDetail`](#transferorder-item-inventorydetail) |  |
...
Browser definition `transferOrder-shippingAddress`.
...
Browser definition `transferOrderCollection`.

| Property | Label | Type | Format | Flags | Ref | Enum |
| --- | --- | --- | --- | --- | --- | --- |
| `count` | Count | integer | int64 | read-only |  |  |
| `hasMore` | Has More Results | boolean |  | read-only |  |  |
| `items` | Items | transferOrder[] |  |  | [`transferOrder`](#transferorder) |  |
| `links` | Links | nsLink[] |  | read-only | [`nsLink`](ns.md#nslink) |  |
| `offset` | Query Offset | integer | int64 | read-only |  |  |
| `totalResults` | Total Results | integer | int64 | read-only |  |  |

## transferOrderSelectOptions

Browser definition `transferOrderSelectOptions`.
