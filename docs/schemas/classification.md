...
Property tables for definitions owned by `classification`.

Record page: [classification](../records/classification.md).

## Index

- [classification](#classification) — 13 properties
- [classification-classTranslationCollection](#classification-classtranslationcollection) — 6 properties
- [classification-classTranslationElement](#classification-classtranslationelement) — 7 properties
- [classificationCollection](#classificationcollection) — 6 properties
- [classificationSelectOptions](#classificationselectoptions) — 2 properties

## classification

Browser definition `classification`.

| Property | Label | Type | Format | Flags | Ref | Enum |
| --- | --- | --- | --- | --- | --- | --- |
| `classTranslation` |  | classification-classTranslationCollection |  |  | [`classification-classTranslationCollection`](#classification-classtranslationcollection) |  |
...
| `name` | Name | string |  |  |  |  |
| `parent` |  | classification |  |  | [`classification`](#classification) |  |
...
Browser definition `classification-classTranslationCollection`.

| Property | Label | Type | Format | Flags | Ref | Enum |
| --- | --- | --- | --- | --- | --- | --- |
| `count` | Count | integer | int64 | read-only |  |  |
| `hasMore` | Has More Results | boolean |  | read-only |  |  |
| `items` |  | classification-classTranslationElement[] |  |  | [`classification-classTranslationElement`](#classification-classtranslationelement) |  |
| `links` | Links | nsLink[] |  | read-only | [`nsLink`](ns.md#nslink) |  |
...
Browser definition `classification-classTranslationElement`.
...
Browser definition `classificationCollection`.

| Property | Label | Type | Format | Flags | Ref | Enum |
| --- | --- | --- | --- | --- | --- | --- |
| `count` | Count | integer | int64 | read-only |  |  |
| `hasMore` | Has More Results | boolean |  | read-only |  |  |
| `items` | Items | classification[] |  |  | [`classification`](#classification) |  |
| `links` | Links | nsLink[] |  | read-only | [`nsLink`](ns.md#nslink) |  |
| `offset` | Query Offset | integer | int64 | read-only |  |  |
| `totalResults` | Total Results | integer | int64 | read-only |  |  |
...
Browser definition `classificationSelectOptions`.
