...
Property tables for definitions owned by `markupItem`.

Record page: [markupItem](../records/markupItem.md).

## Index

- [markupItem](#markupitem) — 32 properties
- [markupItem-translationsCollection](#markupitem-translationscollection) — 6 properties
- [markupItem-translationsElement](#markupitem-translationselement) — 16 properties
- [markupItemCollection](#markupitemcollection) — 6 properties
- [markupItemSelectOptions](#markupitemselectoptions) — 11 properties

## markupItem

Browser definition `markupItem`.
...
| `parent` |  | markupItem |  |  | [`markupItem`](#markupitem) |  |
...
| `translations` |  | markupItem-translationsCollection |  |  | [`markupItem-translationsCollection`](#markupitem-translationscollection) |  |
| `upcCode` | UPC Code | string |  |  |  |  |
| `vendorName` | Vendor Name/Code | string |  |  |  |  |

## markupItem-translationsCollection

Browser definition `markupItem-translationsCollection`.

| Property | Label | Type | Format | Flags | Ref | Enum |
| --- | --- | --- | --- | --- | --- | --- |
| `count` | Count | integer | int64 | read-only |  |  |
| `hasMore` | Has More Results | boolean |  | read-only |  |  |
| `items` |  | markupItem-translationsElement[] |  |  | [`markupItem-translationsElement`](#markupitem-translationselement) |  |
| `links` | Links | nsLink[] |  | read-only | [`nsLink`](ns.md#nslink) |  |
...
Browser definition `markupItem-translationsElement`.
...
Browser definition `markupItemCollection`.

| Property | Label | Type | Format | Flags | Ref | Enum |
| --- | --- | --- | --- | --- | --- | --- |
| `count` | Count | integer | int64 | read-only |  |  |
| `hasMore` | Has More Results | boolean |  | read-only |  |  |
| `items` | Items | markupItem[] |  |  | [`markupItem`](#markupitem) |  |
| `links` | Links | nsLink[] |  | read-only | [`nsLink`](ns.md#nslink) |  |
| `offset` | Query Offset | integer | int64 | read-only |  |  |
| `totalResults` | Total Results | integer | int64 | read-only |  |  |

## markupItemSelectOptions

Browser definition `markupItemSelectOptions`.
