...
Property tables for definitions owned by `descriptionItem`.

Record page: [descriptionItem](../records/descriptionItem.md).

## Index

- [descriptionItem](#descriptionitem) — 21 properties
- [descriptionItem-translationsCollection](#descriptionitem-translationscollection) — 6 properties
- [descriptionItem-translationsElement](#descriptionitem-translationselement) — 16 properties
- [descriptionItemCollection](#descriptionitemcollection) — 6 properties
- [descriptionItemSelectOptions](#descriptionitemselectoptions) — 7 properties

## descriptionItem

Browser definition `descriptionItem`.
...
| `translations` |  | descriptionItem-translationsCollection |  |  | [`descriptionItem-translationsCollection`](#descriptionitem-translationscollection) |  |

## descriptionItem-translationsCollection

Browser definition `descriptionItem-translationsCollection`.

| Property | Label | Type | Format | Flags | Ref | Enum |
| --- | --- | --- | --- | --- | --- | --- |
| `count` | Count | integer | int64 | read-only |  |  |
| `hasMore` | Has More Results | boolean |  | read-only |  |  |
| `items` |  | descriptionItem-translationsElement[] |  |  | [`descriptionItem-translationsElement`](#descriptionitem-translationselement) |  |
| `links` | Links | nsLink[] |  | read-only | [`nsLink`](ns.md#nslink) |  |
...
Browser definition `descriptionItem-translationsElement`.
...
Browser definition `descriptionItemCollection`.

| Property | Label | Type | Format | Flags | Ref | Enum |
| --- | --- | --- | --- | --- | --- | --- |
| `count` | Count | integer | int64 | read-only |  |  |
| `hasMore` | Has More Results | boolean |  | read-only |  |  |
| `items` | Items | descriptionItem[] |  |  | [`descriptionItem`](#descriptionitem) |  |
| `links` | Links | nsLink[] |  | read-only | [`nsLink`](ns.md#nslink) |  |
| `offset` | Query Offset | integer | int64 | read-only |  |  |
| `totalResults` | Total Results | integer | int64 | read-only |  |  |

## descriptionItemSelectOptions

Browser definition `descriptionItemSelectOptions`.
