...
Property tables for definitions owned by `taxAcct`.

Record page: [taxAcct](../records/taxAcct.md).

## Index

- [taxAcct](#taxacct) — 14 properties
- [taxAcctCollection](#taxacctcollection) — 6 properties
- [taxAcctSelectOptions](#taxacctselectoptions) — 3 properties

## taxAcct

Browser definition `taxAcct`.
...
| `taxAcctType` |  | object |  |  |  |  |
| `taxAcctType.id` | Internal identifier | string |  |  |  | `purchase`, `sale` |
| `taxAcctType.refName` | Reference Name | string |  |  |  |  |

## taxAcctCollection

Browser definition `taxAcctCollection`.

| Property | Label | Type | Format | Flags | Ref | Enum |
| --- | --- | --- | --- | --- | --- | --- |
| `count` | Count | integer | int64 | read-only |  |  |
| `hasMore` | Has More Results | boolean |  | read-only |  |  |
| `items` | Items | taxAcct[] |  |  | [`taxAcct`](#taxacct) |  |
| `links` | Links | nsLink[] |  | read-only | [`nsLink`](ns.md#nslink) |  |
| `offset` | Query Offset | integer | int64 | read-only |  |  |
| `totalResults` | Total Results | integer | int64 | read-only |  |  |

## taxAcctSelectOptions

Browser definition `taxAcctSelectOptions`.
...
| `taxAcctType` |  | nsResourceSelectOptions |  |  | [`nsResourceSelectOptions`](ns.md#nsresourceselectoptions) |  |
